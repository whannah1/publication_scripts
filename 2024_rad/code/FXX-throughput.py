...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
cases,name,clr,dsh,mrk = [],[],[],[],[]
def add_case(case_in,n=None,d=0,m=1,c='black'):
   global name,case,clr,dsh,mrk
   if n is None: n = '' 
   cases.append(case_in); name.append(n); dsh.append(d) ; clr.append(c) ; mrk.append(m)
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# # copy data
# print('Copying timing data...')
# if not os.path.exists('timing_data'): os.mkdir('timing_data')
# for c,case in enumerate(cases):
#    timing_dir1 = os.getenv('HOME')+f'/E3SM/Cases/{case}/timing'
#    timing_dir2 = f'timing_data/{case}'
#    if not os.path.exists(timing_dir2): os.mkdir(timing_dir2)
#    cmd = f'cp {timing_dir1}/* {timing_dir2}/'
#    print(f'  {cmd}')
#    os.system(cmd)
# exit()
#-------------------------------------------------------------------------------
fig_file = 'figs/FXX-throughput'
...
for param in param_list :
   ...
   for c,case in enumerate(cases):
      ...
      if print_data: print(f'average: {hc.tcolor.GREEN}{avg:6.3}{hc.tcolor.ENDC}')
   ...
   if param=='physics_fraction': res.trYMinF = np.min(py)-0.1*dy
   ...
   # if param=='physics_fraction': lmax,dl1,dl2 = 20,2,10
   if lmax is None:
   ...
   print(); print('apx: '); print(apx)
   print(); print('apx: '); print(apy)
...
for p,param in enumerate(param_list) :
   ...
   for c,case in enumerate(cases):
      avg = davg_list[c]
      print(f'  {case:{max_case_len}} : {hc.tcolor.GREEN}{avg:6.3}{hc.tcolor.ENDC}')
