...
def add_case(case_in,n=None,d=None,s=None,g=None):
   ...
   case_dir.append(d); case_sub.append(s); case_grid.append(g)
var,lev_list = [],[]
...
fig_type = 'png'
fig_file = 'figs/F09-wk-wave-spectra'
...
htype,years,months,first_file,num_files = 'h1',[],[],0,365*num_year
# htype,years,months,first_file,num_files = 'h1',[],[],100,365*3
...
for v in range(num_var):
   ...
   for c in range(num_case):
      ...
      if recalculate_spectra :
         ...
         data = case_obj.load_data(tvar,htype='h1',years=years,months=months
