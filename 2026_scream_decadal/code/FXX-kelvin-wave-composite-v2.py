...
def add_case(case_in,n=None,comp=None,htype=None,p=None,s=None,d=0,c='black',m=0):
   ...
   if comp  is None: raise ValueError(f'ERROR - add_case: comp arguemnt cannot be None')
   if htype is None: raise ValueError(f'ERROR - add_case: htype arguemnt cannot be None')
   if p     is None: raise ValueError(f'ERROR - add_case: p arguemnt cannot be None')
   if s     is None: raise ValueError(f'ERROR - add_case: s arguemnt cannot be None')
