...
# tmp_path_ne256_1 = '/global/cfs/cdirs/e3sm/beydoun/decadal_monthly_files_untuned'
# tmp_path_ne256_2 = '/global/cfs/cdirs/e3sm/beydoun/decadal_monthly_files_final_tuned'
...
add_case('ne256pg2_ne256pg2.F20TR-SCREAMv1.May-12.with.rain.frac.n0128',                 n='SCREAM 13-km control',comp='eamxx',htype='_ANN_199501_200512_climo',p=tmp_path_ne256, s='climo_180x360')
add_case('ne256pg2_ne256pg2.F20TR-SCREAMv1.July-1.spanc800.2xauto.acc150.n0032.test2.1', n='SCREAM 13-km tuned',  comp='eamxx',htype='_ANN_199501_200512_climo',p=tmp_path_ne256, s='climo_180x360')
...
mkdir /global/cfs/cdirs/e3smdata/simulations/scream-decadal-ne256/ne256pg2_ne256pg2.F20TR-SCREAMv1.July-1.spanc800.2xauto.acc150.n0032.test2.1/climo_180x360
mkdir /global/cfs/cdirs/e3smdata/simulations/scream-decadal-ne256/ne256pg2_ne256pg2.F20TR-SCREAMv1.May-12.with.rain.frac.n0128/climo_180x360


ls -1 /global/cfs/cdirs/e3sm/beydoun/decadal_monthly_files_untuned/climo/*_ANN*
ls -1 /global/cfs/cdirs/e3sm/beydoun/decadal_monthly_files_final_tuned/climo/*_ANN*

GRID_ROOT=/global/homes/w/whannah/publication_scripts/2026_scream_decadal/files_grid
MAPS_ROOT=/global/homes/w/whannah/publication_scripts/2026_scream_decadal/files_maps
SRC_GRID=$GRID_ROOT/ne30pg2_scrip.nc
DST_GRID=$GRID_ROOT/cmip_180x360_scrip.nc
MAP_FILE=$MAPS_ROOT/map_ne30pg2_to_180x360_traave.20260224.nc
# ncremap -6 --alg_typ=traave --grd_src=$SRC_GRID --grd_dst=$DST_GRID --map=$MAP_FILE

SRC_ROOT=/global/cfs/cdirs/e3sm/beydoun/decadal_monthly_files_untuned/climo
DST_ROOT=/global/cfs/cdirs/e3smdata/simulations/scream-decadal-ne256/ne256pg2_ne256pg2.F20TR-SCREAMv1.May-12.with.rain.frac.n0128/climo_180x360
SRC_FILE=$SRC_ROOT/eamxx_decadal_ANN_199501_200512_climo.nc
DST_FILE=$DST_ROOT/eamxx_decadal_ANN_199501_200512_climo_180x360.nc

SRC_ROOT=/global/cfs/cdirs/e3sm/beydoun/decadal_monthly_files_final_tuned/climo
DST_ROOT=/global/cfs/cdirs/e3smdata/simulations/scream-decadal-ne256/ne256pg2_ne256pg2.F20TR-SCREAMv1.July-1.spanc800.2xauto.acc150.n0032.test2.1/climo_180x360
SRC_FILE=$SRC_ROOT/eamxx_decadal_ANN_199501_200512_climo.nc
DST_FILE=$DST_ROOT/eamxx_decadal_ANN_199501_200512_climo_180x360.nc

echo $DST_FILE

ncremap --pdq_opt=time,lev,ncol --vars=qv,hyam,hybm,ps --tmp_dir=${DST_ROOT}/ -m ${MAP_FILE} -i ${SRC_FILE} -o ${DST_FILE}
