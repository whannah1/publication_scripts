...
# add_case('MAC-PG',    n='MAC ne30pg2'                                        ,c='black', p=0)
...
add_case('OBS-PG',    n='OBS'                                                ,c='black',p=0)
# add_case('OBS-FV',    n='OBS 1x1 deg'                                        ,c='gray', p=0)
add_case('E3SM.VTVAL.GNUGPU.ne30pg2_r05_oECv3.F-MMFXX.MOMFB.00',           n='E3SM-MMF'    ,c='red',  p=0)
# add_case('E3SM.VTVAL.GNUGPU.ne30pg2_r05_oECv3.F-MMFXX.MOMFB.VT_0.00',      n='E3SM-MMF+BVT',c='green',p=0)
# add_case('E3SM.VTVAL.GNUGPU.ne30pg2_r05_oECv3.F-MMFXX.MOMFB.VT_1.00',      n='E3SM-MMF+FVT',c='blue', p=0)
add_case('E3SM.VTVAL.GNUGPU.ne30pg2_r05_oECv3.F-MMFXX.MOMFB.MOMVT.VT_0.00',n='E3SM-MMF+BVT',c='green',p=0)
add_case('E3SM.VTVAL.GNUGPU.ne30pg2_r05_oECv3.F-MMFXX.MOMFB.MOMVT.VT_1.00',n='E3SM-MMF+FVT',c='blue',p=0)
#-------------------------------------------------------------------------------
var = []
var.append('TGCLDLWP')
var.append('PRECT')
...
fig_type = 'png'
fig_file = 'figs/F03-chx-occurrence'
...
for n in range(num_plot):
   ...
   for v in range(num_var):
      ...
      if 'OBS' in tmp_base_name: 
         ...
         if var[v]=='PRECT'   : tmp_base_name = tmp_base_name.replace('OBS','IMERG')
...
if num_var==2:
   ...
   for (n,l) in enumerate(lname):
      if 'OBS' in lname[n]: 
         lname[n] = lname[n].replace('OBS','MAC (ne30pg2)')
   xpos = 0.3 if add_diff_plot else 0.5
   ...
   for (n,l) in enumerate(lname):
      if 'OBS' in lname[n]: 
         lname[n] = lname[n].replace('OBS','IMERG (ne30pg2)')
   xpos = 0.3 if add_diff_plot else 0.5
