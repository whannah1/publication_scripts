...
def get_host():
   ...
   return host
#-------------------------------------------------------------------------------
def print_color(msg,color='RED',underline=False,bold=False):
   """ 
   print a message in colord text
   """
   msg = getattr(tcolor,color) + msg + tcolor.ENDC
   if underline: msg = getattr(tcolor,'UNDERLINE') + msg + tcolor.ENDC
   if bold:      msg = getattr(tcolor,'BOLD')      + msg + tcolor.ENDC
   print(msg)
#-------------------------------------------------------------------------------
def printline(n=80):
   """ 
