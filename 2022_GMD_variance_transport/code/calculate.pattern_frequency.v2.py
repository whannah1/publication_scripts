...
# add_case('E3SM.VTVAL.GNUGPU.ne30pg2_r05_oECv3.F-MMFXX.MOMFB.VT_0.00',      n='E3SM-MMF+BVT')
# add_case('E3SM.VTVAL.GNUGPU.ne30pg2_r05_oECv3.F-MMFXX.MOMFB.VT_1.00',      n='E3SM-MMF+FVT')
...
htype,num_year = 'h1',10 ; num_files,num_files_obs = 365*num_year,12*num_year
# htype = 'h1' ; num_files = 0 # use all data from short term cases
...
for v in range(num_var) :
   ...
   for c in range(num_case):
      ...
      if 'OBS'  in case[c]: 
         ...
         if case[c]=='OBS-FV' and var[v]=='TGCLDLWP': case_obj.file_path = f'{case_obj.data_dir}/{case_obj.name}/daily_cwp/*'
         if case[c]=='OBS-PG' and var[v]=='TGCLDLWP': case_obj.file_path = f'{case_obj.data_dir}/{case_obj.name}/daily_cwp_ne30pg2/*'
         if case[c]=='OBS-FV' and var[v]=='PRECT'   : case_obj.file_path = f'{case_obj.data_dir}/{case_obj.name}/daily_180x360/*'
         if case[c]=='OBS-PG' and var[v]=='PRECT'   : case_obj.file_path = f'{case_obj.data_dir}/{case_obj.name}/daily_ne30pg2/*'
