...
use_vt_t, use_vt_q, use_vt_u = False, False, False
...
# use_vt_t, use_vt_q, use_vt_u = True,  False, False
# use_vt_t, use_vt_q, use_vt_u = False, True,  False
# use_vt_t, use_vt_q, use_vt_u = False, False, True

# use_vt_t, use_vt_q, use_vt_u = True,  False, True
use_vt_t, use_vt_q, use_vt_u = False, True,  True
# use_vt_t, use_vt_q, use_vt_u = True,  True,  False



stop_opt,stop_n,resub,walltime = 'ndays',10,0,'1:00'
...
case_list = ['E3SM','VTVAL-HC',arch,grid,compset]
...
if 'MMF' in compset:
   ...
   if use_vt_t or use_vt_q or use_vt_u: 
      case_mod = 'TEST_'
      if use_vt_t: case_mod = case_mod+'T'
      if use_vt_q: case_mod = case_mod+'Q'
      if use_vt_u: case_mod = case_mod+'U'
      case_list.append(case_mod)
...
if config :
   ...
   if use_vt_t or use_vt_q or use_vt_u: cpp_opt += ' -DMMF_VT_TEST '
   if use_vt_t: cpp_opt += ' -DMMF_VT_USE_T'
   if use_vt_q: cpp_opt += ' -DMMF_VT_USE_Q'
   if use_vt_u: cpp_opt += ' -DMMF_VT_USE_U'
