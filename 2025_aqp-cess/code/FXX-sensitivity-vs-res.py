...
# add_var('ECS','Cess Feedback Parameter [W m-2 K-1]')
...
fig_file,fig_type = 'figs/FXX-sensitivity-vs-res','png'

htype,first_file,last_file = 'h0',int(100/10),int(500/10)
tmp_file_head     = 'data/sensitivity-vs-res'
...
for v in range(num_var):
   ...
   if var_list[v] in ['ECS']:
      ...
      res.tiYAxisString          = delta_symbol+var_name[v]
   ...
   if v==0:
      ...
      res.pmLegendOrthogonalPosF =-0.4 # lower-right
      res.pmLegendParallelPosF   = 0.8
   ...
   # hs.set_subtitles(wks, plot, '', '', '', font_height=0.012)
