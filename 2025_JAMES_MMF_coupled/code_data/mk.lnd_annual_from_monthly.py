...
data_sub = 'archive/lnd/hist'
add_case('E3SM.INCITE2023-CPL.ne30pg2_EC30to60E2r2.WCYCL20TR-MMF1',n='E3SM-MMF',p='/global/cfs/cdirs/m3312/whannah/2023-CPL',s=data_sub)
add_case('v2.LR.historical_0101',n='E3SMv2 101',p='/global/cfs/cdirs/m3312/whannah/e3smv2_historical',s=data_sub)
# add_case('v2.LR.historical_0151',n='E3SMv2 151',p='/global/cfs/cdirs/m3312/whannah/e3smv2_historical',s=data_sub)
# add_case('v2.LR.historical_0201',n='E3SMv2 201',p='/global/cfs/cdirs/m3312/whannah/e3smv2_historical',s=data_sub)
# add_case('v2.LR.historical_0251',n='E3SMv2 251',p='/global/cfs/cdirs/m3312/whannah/e3smv2_historical',s=data_sub)
# add_case('v2.LR.historical_0301',n='E3SMv2 301',p='/global/cfs/cdirs/m3312/whannah/e3smv2_historical',s=data_sub)
...
for c in range(num_case):
   ...
   file_list_all = sorted(glob.glob(f'{file_path}/{case[c]}.{comp}.{htype_in}.*'))
   ...
   # time = time_bnds.isel(hist_interval=0)
   ...
   for yr in range(year_beg,year_end+1):
      outfile = f'{file_path}/{case[c]}.{comp}.{htype_out}.{yr:04d}.nc'
      #----------------------------------------------------------------------------
      ...
      #----------------------------------------------------------------------------
      file_list_tmp = sorted(glob.glob(f'{file_path}/{case[c]}.{comp}.{htype_in}.{yr:04d}*'))
      ...
      ds_out = xr.Dataset()
      ds_out['time_bounds'] = ds['time_bounds'][0][:]
      ds_out['time'] = ds['time'][0]

      for var in ds.variables:
         if var in ['time','time_bounds','date_written','time_written']: 
            continue
