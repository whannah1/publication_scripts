...
case,name = [],[]
clr,dsh,mrk = [],[],[]
def add_case(case_in,n=None,p=None,s=None,d=0,c='black',m=0,scrip_file=None):
...
# add_case('E3SM.2024-AQP-CESS-00.FAQP.GNUCPU.ne30pg2_ne30pg2.NN_32.SSTP_0K.ALT-NCPL_72', n='AQP EAM ne30 +0K NCPL_72',p=tmp_scratch,s=tmp_sub,scrip_file=f'{scrip_file_root}/scrip_ne30pg2.nc')
# add_case('E3SM.2024-AQP-CESS-00.FAQP.GNUCPU.ne45pg2_ne45pg2.NN_64.SSTP_0K.ALT-NCPL_72', n='AQP EAM ne45 +0K NCPL_72',p=tmp_scratch,s=tmp_sub,scrip_file=f'{scrip_file_root}/scrip_ne45pg2.nc')
# add_case('E3SM.2024-AQP-CESS-00.FAQP.GNUCPU.ne60pg2_ne60pg2.NN_128.SSTP_0K.ALT-NCPL_72',n='AQP EAM ne60 +0K NCPL_72',p=tmp_scratch,s=tmp_sub,scrip_file=f'{scrip_file_root}/scrip_ne60pg2.nc')
# add_case('E3SM.2024-AQP-CESS-00.FAQP.GNUCPU.ne90pg2_ne90pg2.NN_256.SSTP_0K.ALT-NCPL_72',n='AQP EAM ne90 +0K NCPL_72',p=tmp_scratch,s=tmp_sub,scrip_file=f'{scrip_file_root}/scrip_ne90pg2.nc')
...
htype,first_file,last_file = 'h1',100,500
