...
# add_var('PRECT')
add_var('TGCLDLWP','clwvi',name='LWP')

fig_file,fig_type = 'figs/FXX-map-low-cld','png'
tmp_file_head = 'data/low-cld'

# lat1,lat2 = -60,60

htype,first_file,num_files = 'ha',35,30 # 1985-2014 (30 years)
...
def get_tmp_file(case,var):
   return f'{tmp_file_head}.{case[c]}.{var[v]}.nc'
#---------------------------------------------------------------------------------------------------
for v in range(num_var):
   ...
   if add_obs: 
      ...
      obs_file = '/global/cfs/cdirs/m3312/whannah/2023-CPL/ERA5/ERA5_ANN_198501_201412_climo.ne30pg2.nc'
      ds = xr.open_dataset(obs_file)
      if print_stats: hc.print_stat(ds[ovar[v]],name=f'ERA5 {ovar[v]}',stat='naxsh',indent='    ',compact=True)
      data_list.insert(0, ds[ovar[v]].mean(dim='time').values )
      name.insert(0,'ERA5')
      case.insert(0,'ERA5')
      num_case = num_case+1
