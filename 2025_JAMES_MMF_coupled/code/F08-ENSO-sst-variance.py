import os, copy, string, ngl, xarray as xr, numpy as np, cmocean, glob, warnings
...
fig_file,fig_type = 'figs/F08-ENSO-sst-variance','png'
...
res.cnLevels = np.arange(0.3,1.9+0.2,0.2)
...
for c in range(num_case):
   ...
   tmp_file = f'data/ENSO.sst-variance.{case[c]}.nc'
   #----------------------------------------------------------------------------
   if recalculate:
      if case[c]=='HadSST':
